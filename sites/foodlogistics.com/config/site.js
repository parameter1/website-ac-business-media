...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://p1-cms-assets.imgix.net/files/base/acbm/fl/image/static/logo/site_logo_large.png?h=45&auto=format,compress&q=70',
      srcset: [
        'https://p1-cms-assets.imgix.net/files/base/acbm/fl/image/static/logo/site_logo_large.png?h=90&auto=format,compress&q=70 2x',
      ],
    },
    footer: {
      src: 'https://p1-cms-assets.imgix.net/files/base/acbm/fl/image/static/logo/site_logo_large.png?h=60&auto=format,compress&q=70',
      srcset: [
        'https://p1-cms-assets.imgix.net/files/base/acbm/fl/image/static/logo/site_logo_large.png?h=120&auto=format,compress&q=70 2x',
      ],
    },
  },
  socialMediaLinks: [
  ...
  contactUs: {
    branding: {
      bgColor: '#1a93f9',
      logo: 'https://p1-cms-assets.imgix.net/files/base/acbm/fl/image/static/logo/site_logo_large.png?h=60&auto=format,compress&q=70',
    },
  ...
  leaders: {
    ...
    header: {
      imgSrc: 'https://p1-cms-assets.imgix.net/files/base/acbm/sdce/image/static/sdc-leaders.png?h=85&auto=format,compress&q=70',
    },
  },
};
