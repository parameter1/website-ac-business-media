...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://p1-cms-assets-acbm.imgix.net/files/base/acbm/fcp/image/static/logo/site_logo.png?h=45&auto=format,compress&q=70',
      srcset: [
        'https://p1-cms-assets-acbm.imgix.net/files/base/acbm/fcp/image/static/logo/site_logo.png?h=90&auto=format,compress&q=70 2x',
      ],
    },
    footer: {
      src: 'https://p1-cms-assets-acbm.imgix.net/files/base/acbm/fcp/image/static/logo/site_logo.png?h=45&auto=format,compress&q=70',
  ...
  contactUs: {
    branding: {
      bgColor: '#000',
      logo: 'https://p1-cms-assets-acbm.imgix.net/files/base/acbm/fcp/image/static/logo/site_logo.png?h=45&auto=format,compress&q=70',
    },
  ...
  inquiry: {
    ...
    logo: 'https://p1-cms-assets-acbm.imgix.net/files/base/acbm/fcp/image/static/logo/site_logo.png?h=45&auto=format,compress&q=70&bg=000000&pad=5',
    bgColor: '#000',
  },
};
